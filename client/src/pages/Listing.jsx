    ...
    <main>
        ...
        {error && 
            <div className="flex flex-col justify-center items-center my-10" >
                ...
                <Link to="/profile" className="hover:underline">Go back</Link>
            </div>
        }
        {
            listing && (
                <div>
                    ...
                    <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
                        <p className="text-2xl font-semibold">
                            {listing.title} - ₹ {listing.offer ? listing.discountPrice.toLocaleString('en-IN') : listing.regularPrice.toLocaleString('en-IN')} {listing.type === "rent" ? "/month" : ""}
                        </p>
