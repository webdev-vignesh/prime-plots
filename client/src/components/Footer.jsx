...
const Footer = () => {
  return (
    <div className="relative w-full bottom-0 px-16 pt-6 flex flex-col bg-teal-700 text-white">
      <div className="flex flex-col sm:flex-row gap-4 justify-evenly">
        <div className="space-y-4">
          ...
          <div>
            <p className="break-words max-w-md">Prime Plots is a premium Plots/ Villa provider
            and the largest platform for buyers and sellers
